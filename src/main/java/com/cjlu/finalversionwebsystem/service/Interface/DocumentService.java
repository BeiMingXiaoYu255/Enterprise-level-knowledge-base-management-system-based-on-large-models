...
public interface DocumentService {
     ...
     * @throws Exception 异常
     */
    ContentRetriever createRetrieverForMultipleFiles(List<String> fileNames) throws Exception;
     ...
     * @throws Exception 异常
     */
    List<Document> loadDocumentsFromMultipleFiles(List<String> fileNames) throws Exception;
}
